const CONTENT = {
  ...
  projects: [
    ...
    {
      title: 'vtow 本地以及云端语音转写',
      desc: '离线语音转写 PWA，支持本地 Whisper 模型和云端 MiMo ASR API，所有推理在浏览器本地完成（云端模式除外），无需服务器。',
      tech: ['Whisper', 'mimo-v2.5-asr', 'HTML/CSS'],
      emoji: '\uD83C\uDFA4',
      liveUrl: 'https://unplage.github.io/vtow',
      codeUrl: 'https://github.com/unplage/vtow',
    },
    {
